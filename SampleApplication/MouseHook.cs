...
namespace SampleApplication
{
    ...
    public class MouseHook : GlobalHook
    {
        ...
        protected override int HookCallbackProcedure(int nCode, int wParam, IntPtr lParam)//钩子子程（回调函数）
        {
        ...
        private MouseButtons GetButton(Int32 wParam)
        {
            ...
            switch (wParam)
            {
                ...
                case WM_LBUTTONDBLCLK:
                    return MouseButtons.Left;//点击鼠标左键
                case WM_RBUTTONDOWN:
                case WM_RBUTTONUP:
                case WM_RBUTTONDBLCLK:
                    return MouseButtons.Right;//点击鼠标右键
                case WM_MBUTTONDOWN:
                case WM_MBUTTONUP:
                case WM_MBUTTONDBLCLK:
                    return MouseButtons.Middle;//点击滚轮
                default:
